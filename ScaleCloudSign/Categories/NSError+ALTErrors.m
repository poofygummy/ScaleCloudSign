...
+ (void)load
{
    [NSError setUserInfoValueProviderForDomain:ScaleCloudSignErrorDomain provider:^id _Nullable(NSError * _Nonnull error, NSErrorUserInfoKey  _Nonnull userInfoKey) {
